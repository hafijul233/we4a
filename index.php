...
<main role="main" class="flex-shrink-0">
    <div class="container">
        ...
        <a class="font-weight-bold" href="week-2/index.php">Week 2 Assignment</a>
        <p class="lead">
            <a class="text-dark" href="https://www.wa4e.com/assn/autosdb" target="_blank">Specification for this Application</a>
        </p>
